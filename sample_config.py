...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Kiwity")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", " Kiwity")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Kiwity")
    ...
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @TT54T")
